...
const ADULT_CATALOG: Record<string, MedEntry[]> = {
  ...
  "Dermatologia - Acne (Tópicos)": [
    { name: "Adapaleno 0,1% gel", posology: "Aplicar fina camada à noite em todo rosto, após higienização. Iniciar 3x/semana e progredir." },
    { name: "Adapaleno 0,3% gel", posology: "Aplicar fina camada à noite. Para acne moderada/refratária." },
    { name: "Peróxido de Benzoíla 5% gel", posology: "Aplicar pela manhã sobre lesões. Pode descorar tecidos." },
    { name: "Adapaleno + Peróxido de Benzoíla 0,1%/2,5% (Epiduo)", posology: "Aplicar fina camada à noite, 1x/dia." },
    { name: "Clindamicina 1% gel", posology: "Aplicar 2x/dia sobre lesões inflamatórias." },
    { name: "Ácido Azelaico 15-20% creme", posology: "Aplicar 2x/dia. Útil em acne e melasma." },
    { name: "Tretinoína 0,025% / 0,05% creme", posology: "Aplicar à noite. Iniciar 2-3x/semana, progredir gradualmente." },
  ],
  "Dermatologia - Acne (Sistêmicos)": [
    { name: "Doxiciclina 100mg", posology: "Tomar 1 comprimido ao dia por 8-12 semanas. Tomar com bastante água, longe do sol." },
    { name: "Minociclina 100mg", posology: "Tomar 1 comprimido ao dia por 8-12 semanas." },
    { name: "Limeciclina 300mg", posology: "Tomar 1 cápsula ao dia por 8-12 semanas." },
    { name: "Isotretinoína 20mg", posology: "Tomar conforme peso (0,5-1mg/kg/dia) por 4-8 meses. EXIGE TERMO + contracepção." },
    { name: "Espironolactona 50-100mg", posology: "Tomar 1 a 2 comprimidos ao dia (acne hormonal feminina). Off-label." },
  ],
  "Dermatologia - Melasma e Despigmentantes": [
    { name: "Hidroquinona 4% creme", posology: "Aplicar à noite nas áreas afetadas, por até 6 meses. FPS obrigatório de dia." },
    { name: "Tríplice de Kligman (HQ4% + Tretinoína 0,05% + Hidrocortisona 1%)", posology: "Aplicar à noite por 8 semanas. Reduzir frequência após resposta." },
    { name: "Ácido Tranexâmico tópico 5%", posology: "Aplicar pela manhã, antes do FPS." },
    { name: "Ácido Tranexâmico 250mg", posology: "Tomar 1 comprimido de 12 em 12 horas por 3-6 meses. Avaliar contraindicações tromboembólicas." },
    { name: "Niacinamida 4-5% sérum", posology: "Aplicar 1-2x/dia. Coadjuvante em hiperpigmentação." },
    { name: "Ácido Kójico 2% creme", posology: "Aplicar 2x/dia." },
  ],
  "Dermatologia - Rosácea": [
    { name: "Metronidazol 0,75% gel/creme", posology: "Aplicar 2x/dia na face por 8-12 semanas." },
    { name: "Ivermectina 1% creme (Soolantra)", posology: "Aplicar 1x/dia à noite por 12-16 semanas." },
    { name: "Brimonidina 0,33% gel (Mirvaso)", posology: "Aplicar 1x/dia pela manhã, fina camada (eritema persistente)." },
    { name: "Ácido Azelaico 15% gel", posology: "Aplicar 2x/dia." },
    { name: "Doxiciclina 40mg liberação modificada", posology: "Tomar 1 cápsula ao dia por 12 semanas." },
  ],
  "Dermatologia - Alopecia": [
    { name: "Minoxidil 5% solução tópica", posology: "Aplicar 1mL no couro cabeludo seco 2x/dia." },
    { name: "Minoxidil 5% foam", posology: "Aplicar meia tampa 2x/dia (sem propilenoglicol)." },
    { name: "Minoxidil oral 0,25-2,5mg", posology: "Tomar 1 comprimido ao dia. Off-label, monitorar PA e edema." },
    { name: "Finasterida 1mg", posology: "Tomar 1 comprimido ao dia (homens). Avaliar efeitos sexuais." },
    { name: "Dutasterida 0,5mg", posology: "Tomar 1 cápsula ao dia (refratários, off-label para alopecia)." },
    { name: "Espironolactona 100mg (alopecia ♀)", posology: "Tomar 1 a 2 comprimidos ao dia." },
  ],
  "Dermatologia - Dermatites e Eczemas": [
    { name: "Hidrocortisona 1% creme", posology: "Aplicar 2x/dia em áreas sensíveis (face, dobras) por até 7 dias." },
    { name: "Mometasona 0,1% creme", posology: "Aplicar 1x/dia por 7-14 dias." },
    { name: "Betametasona 0,05% creme", posology: "Aplicar 2x/dia por 7-14 dias. Não usar em face." },
    { name: "Clobetasol 0,05% creme/pomada", posology: "Aplicar 1-2x/dia por no máximo 14 dias (alta potência)." },
    { name: "Tacrolimo 0,03% / 0,1% pomada", posology: "Aplicar 2x/dia (poupa face e dobras, sem atrofia)." },
    { name: "Pimecrolimo 1% creme", posology: "Aplicar 2x/dia." },
    { name: "Emoliente (Cetaphil/Fisiogel/Hidratante ureia 10%)", posology: "Aplicar várias vezes ao dia, especialmente após banho." },
  ],
  "Dermatologia - Psoríase": [
    { name: "Calcipotriol + Betametasona pomada (Daivobet)", posology: "Aplicar 1x/dia por até 4 semanas." },
    { name: "Coaltar 4-10% creme", posology: "Aplicar 1x/dia à noite." },
    { name: "Metotrexato 2,5mg", posology: "Tomar 6-8 comprimidos (15-20mg) UMA vez por semana + ácido fólico 5mg no dia seguinte." },
    { name: "Acitretina 25mg", posology: "Tomar 1 cápsula ao dia. Contraindicado em mulheres em idade fértil." },
  ],
  "Estética - Fórmulas Manipuladas": [
    { name: "Sérum Antiaging (Vit C 10% + Vit E 1% + Ác. Ferúlico 0,5%)", posology: "Aplicar pela manhã, antes do FPS. Frasco 30mL." },
    { name: "Creme Clareador (Hidroquinona 4% + Ác. Glicólico 5% + Ác. Kójico 2%)", posology: "Aplicar à noite. Frasco 30g. Uso por 4-6 meses." },
    { name: "Creme Antiacne (Adapaleno 0,1% + Niacinamida 4% + Ác. Salicílico 2%)", posology: "Aplicar à noite. Frasco 30g." },
    { name: "Loção Capilar (Minoxidil 5% + Finasterida 0,1% + Tretinoína 0,025%)", posology: "Aplicar 1mL no couro cabeludo 1x/noite." },
    { name: "Loção Capilar Feminina (Minoxidil 2% + Progesterona 2% + Biotina 0,1%)", posology: "Aplicar 1mL 2x/dia." },
    { name: "Sérum para olheiras (Cafeína 5% + Vit K 1% + Hesperidina 2%)", posology: "Aplicar pela manhã na área periorbital." },
    { name: "Creme reparador pós-procedimento (Ác. Hialurônico 1% + Pantenol 5% + Aloe Vera 10%)", posology: "Aplicar 3-4x/dia por 7 dias." },
  ],
  "Estética - Fotoproteção e Coadjuvantes": [
    { name: "Protetor Solar FPS 50+ com cor (FeOx)", posology: "Aplicar pela manhã e reaplicar a cada 3 horas." },
    { name: "Protetor Solar FPS 70 oil-free", posology: "Aplicar pela manhã, reaplicar de 2 em 2 horas se exposição." },
    { name: "Polypodium leucotomos 240mg", posology: "Tomar 1 cápsula ao dia (fotoproteção oral, melasma)." },
    { name: "Heliocare cápsulas", posology: "Tomar 1 cápsula 30 minutos antes da exposição solar." },
    { name: "Colágeno hidrolisado + Ácido Hialurônico 10g", posology: "Diluir 1 sachê em 200mL de água 1x/dia." },
  ],
  "Ginecologia - Anticoncepção": [
    { name: "Etinilestradiol 0,03mg + Levonorgestrel 0,15mg (Ciclo 21)", posology: "Tomar 1 comprimido ao dia, sempre no mesmo horário, por 21 dias. Pausa de 7 dias e reiniciar nova cartela." },
    { name: "Etinilestradiol 0,02mg + Drospirenona 3mg (Yaz/Elani 28)", posology: "Tomar 1 comprimido ao dia por 24 dias ativos + 4 placebos. Sem pausa entre cartelas." },
    { name: "Etinilestradiol 0,03mg + Gestodeno 0,075mg (Tâmisa 30)", posology: "Tomar 1 comprimido ao dia por 21 dias, com pausa de 7 dias." },
    { name: "Desogestrel 75mcg (Cerazette / minipílula)", posology: "Tomar 1 comprimido ao dia, em uso contínuo, sem pausa. Indicada para lactantes." },
    { name: "Acetato de Medroxiprogesterona 150mg/mL (Depo-Provera)", posology: "Aplicar 1 ampola IM profundo a cada 90 dias." },
    { name: "Enantato de Noretisterona 50mg + Estradiol 5mg (Mesigyna/Perlutan)", posology: "Aplicar 1 ampola IM mensalmente, na mesma data." },
    { name: "Implante Etonogestrel 68mg (Implanon NXT)", posology: "Inserção subdérmica no braço não dominante. Eficácia por 3 anos." },
    { name: "DIU LNG 52mg (Mirena)", posology: "Inserção intrauterina. Eficácia por até 8 anos. Reduz fluxo e cólica." },
    { name: "DIU de Cobre TCu 380A", posology: "Inserção intrauterina. Eficácia por até 10 anos. Não hormonal." },
    { name: "Levonorgestrel 1,5mg (anticoncepção de emergência)", posology: "Tomar 1 comprimido em dose única o mais rápido possível, até 72h após relação." },
    { name: "Acetato de Ulipristal 30mg (EllaOne)", posology: "Tomar 1 comprimido em dose única até 120h (5 dias) após a relação." },
  ],
  "Obstetrícia - Suplementação Pré-natal": [
    { name: "Ácido Fólico 5mg", posology: "Tomar 1 comprimido ao dia, iniciar 3 meses pré-concepção e manter até 12 semanas de gestação." },
    { name: "Ácido Fólico 0,4mg", posology: "Tomar 1 comprimido ao dia (mulheres em idade fértil sem risco aumentado)." },
    { name: "Sulfato Ferroso 40mg Fe elementar", posology: "Tomar 1 comprimido ao dia, em jejum, com suco cítrico, a partir da 20ª semana até 3 meses pós-parto." },
    { name: "Carbonato de Cálcio 1250mg + Vitamina D3 400UI", posology: "Tomar 1 comprimido de 12 em 12 horas, longe do sulfato ferroso." },
    { name: "Polivitamínico Gestacional (Materna / Femme Gestare)", posology: "Tomar 1 comprimido ao dia, com a refeição principal." },
    { name: "DHA 200-300mg cápsula", posology: "Tomar 1 cápsula ao dia, com alimento, durante a gestação e lactação." },
    { name: "Iodo 150mcg", posology: "Tomar 1 comprimido ao dia durante gestação e lactação." },
  ],
  "Obstetrícia - Náuseas e Refluxo (seguros na gestação)": [
    { name: "Piridoxina (B6) 40mg + Doxilamina 10mg", posology: "Tomar 2 comprimidos ao deitar; pode acrescentar 1 cp pela manhã e 1 cp à tarde se necessário." },
    { name: "Metoclopramida 10mg", posology: "Tomar 1 comprimido de 8 em 8 horas, 30 min antes das refeições, se náusea persistente." },
    { name: "Dimenidrinato 50mg + Piridoxina 10mg (Dramin B6)", posology: "Tomar 1 comprimido de 6 em 6 horas se náusea." },
    { name: "Ondansetrona 4mg (uso pontual >10 sem)", posology: "Tomar 1 comprimido de 8 em 8 horas se vômitos refratários (avaliar risco/benefício no 1º tri)." },
    { name: "Omeprazol 20mg (categoria C — uso quando necessário)", posology: "Tomar 1 cápsula ao dia em jejum por até 4 semanas." },
    { name: "Ranitidina 150mg", posology: "Tomar 1 comprimido de 12 em 12 horas." },
    { name: "Hidróxido de Alumínio + Magnésio (Mylanta Plus)", posology: "Tomar 10mL após as refeições e ao deitar, se pirose." },
  ],
  "Ginecologia - Infecções vaginais e ITU": [
    { name: "Fluconazol 150mg", posology: "Tomar 1 cápsula em dose única (candidíase). Repetir após 7 dias se necessário." },
    { name: "Miconazol 2% creme vaginal", posology: "Aplicar 1 aplicador via vaginal ao deitar por 7 noites consecutivas." },
    { name: "Clotrimazol óvulo 100mg", posology: "Inserir 1 óvulo via vaginal ao deitar por 6 noites." },
    { name: "Metronidazol 250mg comprimido", posology: "Tomar 2 comprimidos (500mg) de 12 em 12 horas por 7 dias (vaginose bacteriana)." },
    { name: "Metronidazol gel vaginal 0,75%", posology: "Aplicar 1 aplicador via vaginal ao deitar por 5 noites." },
    { name: "Metronidazol 2g (dose única)", posology: "Tomar 4 comprimidos de 500mg em dose única (tricomoníase). Tratar parceiro." },
    { name: "Tinidazol 2g", posology: "Tomar 4 comprimidos de 500mg em dose única, com alimento." },
    { name: "Nitrofurantoína 100mg (ITU não complicada / gestante após 1º tri)", posology: "Tomar 1 cápsula de 6 em 6 horas por 5 a 7 dias." },
    { name: "Cefalexina 500mg (ITU em gestante)", posology: "Tomar 1 comprimido de 6 em 6 horas por 7 dias." },
    { name: "Fosfomicina 3g sachê (Monuril)", posology: "Diluir 1 sachê em 1 copo de água e tomar em dose única, à noite, com a bexiga vazia." },
    { name: "Amoxicilina 500mg (bacteriúria assintomática gestante)", posology: "Tomar 1 cápsula de 8 em 8 horas por 7 dias." },
  ],
  "Ginecologia - IST (MS 2024)": [
    { name: "Penicilina G Benzatina 2.400.000 UI (Benzetacil) — Sífilis recente", posology: "Aplicar 1.200.000 UI IM em cada glúteo (total 2,4 mi) em dose única." },
    { name: "Penicilina G Benzatina 2.400.000 UI — Sífilis tardia/indeterminada", posology: "Aplicar 2,4 mi UI IM 1x/semana por 3 semanas consecutivas (total 7,2 mi UI)." },
    { name: "Ceftriaxona 500mg IM (Gonorreia)", posology: "Aplicar 1 ampola IM em dose única + Azitromicina 1g VO dose única. Tratar parceiro(s)." },
    { name: "Azitromicina 1g (Clamídia)", posology: "Tomar 2 comprimidos de 500mg em dose única, longe das refeições." },
    { name: "Doxiciclina 100mg (Clamídia / DIP leve)", posology: "Tomar 1 comprimido de 12 em 12 horas por 7 dias. Não usar na gestação." },
  ],
  "Obstetrícia - Pré-eclâmpsia e Anti-hipertensivos seguros": [
    { name: "Metildopa 250mg (1ª linha em gestantes)", posology: "Tomar 1 a 2 comprimidos de 8 em 8 horas. Máximo 3g/dia." },
    { name: "Metildopa 500mg", posology: "Tomar 1 comprimido de 12 em 12 horas, ajustar até 2g/dia." },
    { name: "Nifedipino 20mg retard", posology: "Tomar 1 comprimido de 12 em 12 horas. Pode aumentar até 120mg/dia." },
    { name: "Hidralazina 25mg (HAS gestacional)", posology: "Tomar 1 comprimido de 6 em 6 horas, podendo aumentar até 200mg/dia." },
    { name: "AAS 100mg (profilaxia de pré-eclâmpsia)", posology: "Tomar 1 comprimido ao deitar, entre 12 e 36 semanas, em gestantes de alto risco." },
    { name: "Carbonato de Cálcio 1g (profilaxia PE)", posology: "Tomar 1 comprimido de 8 em 8 horas durante toda a gestação se ingesta < 600mg/dia." },
    { name: "Sulfato de Magnésio 50% (Pritchard) — uso hospitalar", posology: "Ataque: 4g IV lento (10 min) + 10g IM (5g em cada glúteo). Manutenção: 5g IM 4/4h por 24h." },
  ],
  "Obstetrícia - Diabetes Gestacional": [
    { name: "Insulina NPH 100UI/mL (gestação)", posology: "Iniciar 0,3-0,5 UI/kg/dia SC, divididas em 2/3 manhã + 1/3 noite. Titular pela glicemia capilar." },
    { name: "Insulina Regular 100UI/mL (pré-prandial)", posology: "Aplicar SC 30 min antes das refeições conforme glicemia capilar pós-prandial alvo (<140mg/dL em 1h)." },
    { name: "Insulina Lispro/Asparte (análogo rápido)", posology: "Aplicar SC imediatamente antes das refeições principais." },
    { name: "Metformina 850mg (off-label, casos selecionados)", posology: "Tomar 1 comprimido de 12 em 12 horas, com refeição. Avaliar com gestante." },
  ],
  "Obstetrícia - Indução, Hemorragia e Pós-parto": [
    { name: "Misoprostol 25mcg vaginal (indução de parto — uso hospitalar)", posology: "Inserir 1 comprimido em fundo de saco vaginal a cada 6h. Máximo 6 doses." },
    { name: "Ocitocina 5UI/mL (Syntocinon)", posology: "Indução: 1-2 mUI/min IV em BI, dobrando a cada 20-30 min. Pós-parto (3º estágio): 10UI IM ou IV diluído após dequitação." },
    { name: "Metilergometrina 0,2mg (Methergin) — atonia uterina", posology: "Aplicar 1 ampola IM. Pode repetir após 2-4h. Contraindicado em HAS/PE." },
    { name: "Misoprostol 200mcg comprimido (atonia uterina)", posology: "Administrar 800-1000mcg via retal em dose única em hemorragia pós-parto refratária." },
    { name: "Ácido Tranexâmico 250mg/5mL ampola (HPP)", posology: "Aplicar 1g IV em 10 min, podendo repetir após 30 min se sangramento persistir." },
    { name: "Cabergolina 0,5mg (inibição da lactação)", posology: "Tomar 2 comprimidos (1mg) em dose única nas primeiras 24h pós-parto." },
    { name: "Domperidona 10mg (galactogogo)", posology: "Tomar 1 comprimido de 8 em 8 horas para estímulo da lactação. Avaliar QTc." },
  ],
  "Ginecologia - Climatério e Reposição Hormonal": [
    { name: "Estradiol 1mg + Acetato de Noretisterona 0,5mg (Activelle)", posology: "Tomar 1 comprimido ao dia, em uso contínuo (mulheres com útero em pós-menopausa)." },
    { name: "Estradiol 1mg (Estrofem) — histerectomizadas", posology: "Tomar 1 comprimido ao dia, em uso contínuo." },
    { name: "Estradiol gel 0,06% (Oestrogel)", posology: "Aplicar 2,5g (1 dose do dispensador) ao dia em pele íntegra dos braços ou coxas." },
    { name: "Tibolona 2,5mg (Livial)", posology: "Tomar 1 comprimido ao dia (somente após 1 ano de menopausa)." },
    { name: "Promestrieno creme vaginal 1% (Colpotrofine)", posology: "Aplicar 1 aplicador via vaginal ao deitar por 20 dias; manutenção 2x/semana (atrofia urogenital)." },
    { name: "Estriol 1mg/g creme vaginal (Ovestrion)", posology: "Aplicar 1 aplicador ao deitar por 2-3 semanas; manutenção 2x/semana." },
    { name: "Paroxetina 7,5mg (não-hormonal para fogachos)", posology: "Tomar 1 comprimido ao deitar." },
    { name: "Venlafaxina 75mg XR", posology: "Tomar 1 cápsula ao dia (fogachos quando TRH contraindicada)." },
    { name: "Cálcio 600mg + Vit D3 400UI", posology: "Tomar 1 comprimido de 12 em 12 horas (saúde óssea pós-menopausa)." },
    { name: "Alendronato 70mg (osteoporose)", posology: "Tomar 1 comprimido por semana, em jejum, com 1 copo de água, permanecer em pé por 30 min." },
  ],
  "Ginecologia - SOP, TPM e Endometriose": [
    { name: "Acetato de Ciproterona 2mg + Etinilestradiol 0,035mg (Diane 35)", posology: "Tomar 1 comprimido ao dia por 21 dias com pausa de 7 dias (hiperandrogenismo/SOP)." },
    { name: "Espironolactona 50-100mg (hirsutismo)", posology: "Tomar 1 a 2 comprimidos ao dia. Associar contracepção." },
    { name: "Metformina 850mg (SOP com resistência insulínica)", posology: "Tomar 1 comprimido de 12 em 12 horas com as refeições." },
    { name: "Dienogeste 2mg (Allurene/Visanne — endometriose)", posology: "Tomar 1 comprimido ao dia em uso contínuo." },
    { name: "Acetato de Medroxiprogesterona 10mg (TPM/sangramento)", posology: "Tomar 1 comprimido ao dia do 16º ao 25º dia do ciclo." },
    { name: "Ácido Mefenâmico 500mg (dismenorreia)", posology: "Tomar 1 comprimido de 8 em 8 horas iniciando 1 dia antes da menstruação por 3 dias." },
    { name: "Drospirenona 4mg (Slinda — progestagênio isolado)", posology: "Tomar 1 comprimido ao dia em uso contínuo." },
  ],
  "Obstetrícia - Tromboprofilaxia e Maturação Pulmonar": [
    { name: "Enoxaparina 40mg/0,4mL SC (profilaxia)", posology: "Aplicar 1 seringa SC 1x/dia (gestantes de risco trombótico)." },
    { name: "Enoxaparina 60mg/0,6mL SC (peso 70-90kg)", posology: "Aplicar 1 seringa SC 1x/dia." },
    { name: "Heparina não-fracionada 5000UI SC", posology: "Aplicar 5000UI SC de 12 em 12 horas." },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          ...
          {/* Prescription print area — 2 vias por folha A4 */}
          <div className="print-area print-two-copies">
            {[
              { key: "via1", label: "1ª via — Paciente" },
              { key: "via2", label: "2ª via — Farmácia / Arquivo" },
            ].map((via, idx) => (
              <div
                key={via.key}
                className={`bg-card rounded-xl shadow-md relative overflow-hidden prescription-copy ${idx === 1 ? "print-only" : ""}`}
                style={{
                  ...
                  marginTop: idx === 1 ? "10mm" : undefined,
                }}
              >
                ...
                {/* Via label — só na impressão */}
                <div
                  className="print-only absolute top-3 left-4 text-[9px] uppercase tracking-[0.18em] font-semibold"
